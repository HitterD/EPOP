...
export declare class ChatService {
    ...
    constructor(chats: Repository<Chat>, participants: Repository<ChatParticipant>, messages: Repository<Message>, reactions: Repository<MessageReaction>, reads: Repository<MessageRead>, outbox: OutboxService);
    ...
    listMessages(userId: string, chatId: string, limit?: number, beforeId?: string): Promise<Message[]>;
